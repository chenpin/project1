...
--关卡选择按钮
CHAPTERBTN = {}
CHAPTERBTN[1] = {pic = "pic/house1.png", pic2 = "pic/house_lock1.png"}
CHAPTERBTN[2] = {pic = "pic/house2.png", pic2 = "pic/house_lock2.png"}
CHAPTERBTN[3] = {pic = "pic/house3.png", pic2 = "pic/house_lock3.png"}
